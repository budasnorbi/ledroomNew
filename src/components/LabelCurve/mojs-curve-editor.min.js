...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _hash = __webpack_require__(187);

	var _hash2 = _interopRequireDefault(_hash);

	var _fallbackTo = __webpack_require__(188);

	var _fallbackTo2 = _interopRequireDefault(_fallbackTo);

	var _defer = __webpack_require__(189);

	var _defer2 = _interopRequireDefault(_defer);

	var _points = __webpack_require__(157);

	var _addPointerDown = __webpack_require__(125);

	var _addPointerDown2 = _interopRequireDefault(_addPointerDown);

	var _getPointsFromPath = __webpack_require__(190);
	...
	*/
	var API = function () {
	  ...
	  (0, _createClass3.default)(API, [{
	    ...
	    value: function _vars() {
	      ...
	      this.store.dispatch({
	        type: 'EDITOR_RESIZE',
	        width: this._o.root.getBoundingClientRect().width
	      });
	    ...
	    value: function _renderApp() {
	      ...
	      (0, _preact.render)((0, _preact.h)(
	        ...
	        { store: this.store },
	        (0, _preact.h)(_curveEditor2.default, { options: this._props, ref: function ref(el) {
	            _this2._el = el;
	          } })
	      ), this._o.root);
	    }
	...
	var rootElement = exports.rootElement = undefined;
	exports.default = API;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _curveEditorLeft = __webpack_require__(143);

	var _curveEditorLeft2 = _interopRequireDefault(_curveEditorLeft);

	var _icons = __webpack_require__(156);
	...
	var _activePool = __webpack_require__(158);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _littleHandle = __webpack_require__(126);
	...
	var Point = function (_Component) {
	  ...
	  (0, _createClass3.default)(Point, [{
	    ...
	    value: function _getStyle(state) {
	      ...
	      var plusNumber = 10 / 100 * x;

	      var translate = 'transform: translate(' + (cleanX + plusNumber) + 'px, ' + (y - 1) + 'px)';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _angleToPoint = __webpack_require__(127);

	var _angleToPoint2 = _interopRequireDefault(_angleToPoint);

	var _pointToAngle = __webpack_require__(128);
	...
	var _pool = __webpack_require__(129);
...
/***/ (function(module, exports) {
	...
	exports.default = function (x, y) {
	  var radius = Math.sqrt(x * x + y * y),
	      angle = Math.atan(isNaN(y / x) ? 0 : y / x) * (180 / Math.PI) - 90;
	  if (x > 0) {
	    angle = angle - 180;
	  };
...
/***/ (function(module, exports) {
	...
	module.exports = {"little-handle":"_little-handle_6fru8_3","little-handle__point":"_little-handle__point_6fru8_1","little-handle__easy-touch":"_little-handle__easy-touch_6fru8_1","little-handle__line":"_little-handle__line_6fru8_1"}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*$PX:      1/16rem;*/\n._point_1xsnm_5 {\n  position:       absolute;\n  width:          10px;\n  height:         10px;\n  margin-left:    -5px;\n  margin-top:     -5px;\n  cursor:         move;\n  background:     #FFFFFF;\n  border-radius:  50%;\n  z-index:        3;\n  /* box-shadow:     calc(3*$PX) calc(3*$PX) 0 rgba(0,0,0,.5); */\n}\n/*border:         calc( 2*$PX ) solid $c-white;*/\n._point_1xsnm_5 [data-component=\"little-handle\"] {\n  display: none;\n}\n._point__touch_1xsnm_1 {\n  position:       absolute;\n  left:       50%;\n  top:       50%;\n  width:       20px;\n  height:       20px;\n  margin-left:       -10px;\n  margin-top:       -10px;\n}\n._point_1xsnm_5:hover, ._point_1xsnm_5._is-selected_1xsnm_31 {\n  /*border-color: #8C6D8B;*/\n  /*border-color: $c-orange;*/\n  background:       #FF512F;\n}\n._point_1xsnm_5._is-selected_1xsnm_31 {}\n._point_1xsnm_5._is-selected_1xsnm_31 [data-component=\"little-handle\"] {\n  display:       block;\n}\n._point_1xsnm_5._is-hide-handles_1xsnm_43 {}\n._point_1xsnm_5._is-hide-handles_1xsnm_43 [data-component=\"little-handle\"] {\n  display:       none;\n}\n\n", ""]);
...
/***/ (function(module, exports) {
	...
	module.exports = {"point":"_point_1xsnm_5","point__touch":"_point__touch_1xsnm_1","is-selected":"_is-selected_1xsnm_31","is-hide-handles":"_is-hide-handles_1xsnm_43"}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*$PX:      1/16rem;*/\n._curve_1vsz4_5 {\n  position:       absolute;\n  left:           0;\n  top:0;\n  right:0;\n  bottom: 0;\n  /*top:            calc( $gap * $PX );\n  right:          calc( $gap * $PX );\n  bottom:         calc( $gap * $PX );\n  border-radius:  calc( 2 * $PX ); */\n  /* background:     rgba( 58, 8, 58, .75 ); */\n  /* border:         1px solid $c-pastel-purple; */\n  /* border-left:solid 1px rgba(255,255,255,.25); */\n  /* box-shadow:     inset calc( 4 * $PX ) calc( 4 * $PX ) 0 rgba(0,0,0,0.5); */\n  border:solid 1px rgba(255, 255, 255, .15);\n  border-radius:2px;\n  z-index:        2;\n  overflow:       hidden\n}\n._curve__background_1vsz4_1 {\n  position:       absolute;\n  z-index:       0;\n  top:       0;\n  bottom:       0;\n  width:       350px;\n  left:       0;\n  opacity:       0.5;\n  border-radius:       inherit\n}\n._curve__background_1vsz4_1 svg {\n  width:       100%\n}\n._curve__background_1vsz4_1 path {\n  vector-effect:       non-scaling-stroke\n}\n._curve__svg-wrapper_1vsz4_1 {\n  position:       absolute;\n  z-index:       1;\n  left:       -1px;\n  right:       -1px\n}\n._curve__svg_1vsz4_1 {\n  display:       block;\n  overflow:       visible;\n  width:       100%;\n  position:       relative;\n  z-index:       1\n}\n._curve__svg-segment_1vsz4_1 {\n  stroke:       white;\n  stroke-width:       2px;\n  cursor:       crosshair\n}\n._curve__svg-segment_1vsz4_1:hover {\n  stroke:       #FF512F\n}\n", ""]);
...
/***/ (function(module, exports) {
	...
	module.exports = {"curve":"_curve_1vsz4_5","curve__background":"_curve__background_1vsz4_1","curve__svg-wrapper":"_curve__svg-wrapper_1vsz4_1","curve__svg":"_curve__svg_1vsz4_1","curve__svg-segment":"_curve__svg-segment_1vsz4_1"}

/***/ }),
/* 142 */
/***/ (function(module, exports) {

	module.exports = {"curve-editor":"_curve-editor_12ekd_6","curve-editor__left":"_curve-editor__left_12ekd_1","curve-editor__right":"_curve-editor__right_12ekd_138","curve-editor__resize-handle":"_curve-editor__resize-handle_12ekd_1","curve-editor__anchor-buttons":"_curve-editor__anchor-buttons_12ekd_133","curve-editor__mojs-logo":"_curve-editor__mojs-logo_12ekd_116","is-inactive":"_is-inactive_12ekd_115","is-minimized":"_is-minimized_12ekd_123","curve__svg-wrapper":"_curve__svg-wrapper_12ekd_142","is-hidden-on-min":"_is-hidden-on-min_12ekd_152"}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pointControls = __webpack_require__(144);
...
/***/ (function(module, exports) {
	...
	module.exports = {"icon-button":"_icon-button_rktr1_4","is-checked":"_is-checked_rktr1_32"}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*$PX:      1/16rem;*/\n\n._point-controls_l9voo_4 {\n  display: none\n\n}\n\n._point-controls_l9voo_4._is-show_l9voo_7 {\n  opacity: 1;\n  display: block\n\n}\n", ""]);
...
/***/ (function(module, exports) {
	...
	module.exports = {"point-controls":"_point-controls_l9voo_4","is-show":"_is-show_l9voo_7"}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*$PX:      1/16rem;*/\nbody{\n  margin:0 ;\n  padding: 0;\n}\n._curve-editor_12ekd_6 {\n  /*border: calc( 2*$PX ) dotted transparent;*/\n  /* position:       fixed;*/\n  /* left:           0; */\n  /* top:            0;*/\n  width:          403px;\n  height:         378px;\n  /* border-radius:  calc( 12 * $PX ); */\n  /* background:     $c-light-purple; */\n  z-index:        100;\n\n  /* all static on minimize classes */\n\n\n  /*&.is-highlighted {\n    border-color: $c-orange;\n  }*/\n\n}\n/* box-shadow:     0 0 calc( 3*$PX ) calc( 1*$PX ) rgba(0,0,0,.38); */\n._curve-editor_12ekd_6 [data-component=\"maximize-button\"] {\n  display:      none;\n}\n._curve-editor_12ekd_6 *{\n  box-sizing:border-box;\n}\n._curve-editor__left_12ekd_1{\n  position:absolute;\n  width:42px;\n  left:0;\n  top:0;\n  bottom:0;\n  /* padding:      calc($gap*$PX);*/\n}\n/* cursor:       move; */\n._curve-editor__left_12ekd_1 [data-component=\"code-button\"]{\n  /* margin-top: calc(5*$PX); */\n}\n._curve-editor__left_12ekd_1 [data-component=\"icon-divider\"]{\n  margin:10px auto;\n}\n._curve-editor__right_12ekd_138{\n  position:absolute;\n  left:43px;\n  top:0;\n  right:0;\n  bottom:0;\n}\n._curve-editor__right_12ekd_138:after{\n  content:'';\n  position:absolute;\n  left:0;\n  top:0;\n  right:0;\n  bottom:0;\n  z-index:2;\n  display:none;\n}\n._curve-editor__resize-handle_12ekd_1{\n  position:absolute;\n}\n._curve-editor__resize-handle_12ekd_1[data-type=\"top\"]{\n  top:-17px;\n}\n._curve-editor__resize-handle_12ekd_1[data-type=\"bottom\"]{\n  bottom:1px;\n}\n._curve-editor__resize-handle_12ekd_1[data-type=\"top\"], ._curve-editor__resize-handle_12ekd_1[data-type=\"bottom\"]{\n  left:50%;\n  margin-left:-21px;\n}\n._curve-editor__resize-handle_12ekd_1[data-type=\"right\"]{\n  right:-15px;\n  top:50%;\n  margin-top:-16px;\n}\n._curve-editor__anchor-buttons_12ekd_133{\n  /* margin-top:   calc(  10*$PX ); */\n  margin-top:7px;\n  /*display:      none;*/\n}\n._curve-editor__anchor-buttons_12ekd_133 [data-component=\"icon-button\"]{\n  margin-bottom:5px;\n}\n._curve-editor__mojs-logo_12ekd_116{\n  position:absolute;\n  bottom:17px;\n  left:50%;\n  margin-left:1px;\n  transform:translateX(-50%);\n}\n._curve-editor__mojs-logo_12ekd_116 [data-component=\"icon\"]{\n  fill:#FF512F;\n  width:12px;\n  height:12px;\n}\n._curve-editor_12ekd_6._is-inactive_12ekd_115 ._curve-editor__mojs-logo_12ekd_116{}\n._curve-editor_12ekd_6._is-inactive_12ekd_115 ._curve-editor__mojs-logo_12ekd_116 [data-component=\"icon\"]{\n  fill:#9C829A;\n}\n._curve-editor_12ekd_6._is-minimized_12ekd_123{\n  width:100px !important;\n  height:45px  !important;\n}\n/*border-radius:  calc(7 * $PX); */\n._curve-editor_12ekd_6._is-minimized_12ekd_123 [data-component=\"resize-handle\"], ._curve-editor_12ekd_6._is-minimized_12ekd_123 [data-component=\"point\"], ._curve-editor_12ekd_6._is-minimized_12ekd_123 [data-component=\"icon-divider\"], ._curve-editor_12ekd_6._is-minimized_12ekd_123 [data-component=\"minimize-button\"], ._curve-editor_12ekd_6._is-minimized_12ekd_123 [data-component=\"code-button\"], ._curve-editor_12ekd_6._is-minimized_12ekd_123 ._curve-editor__anchor-buttons_12ekd_133, ._curve-editor_12ekd_6._is-minimized_12ekd_123 ._curve-editor__mojs-logo_12ekd_116{\n  display:none;\n}\n._curve-editor_12ekd_6._is-minimized_12ekd_123 ._curve-editor__right_12ekd_138:after{\n  display:block;\n}\n._curve-editor_12ekd_6._is-minimized_12ekd_123 ._curve__svg-wrapper_12ekd_142{\n  margin-top:-200px;\n}\n._curve-editor_12ekd_6._is-minimized_12ekd_123 [data-component=\"maximize-button\"]{\n  display:block;\n}\n._curve-editor_12ekd_6._is-hidden-on-min_12ekd_152._is-minimized_12ekd_123{\n  display:none;\n}\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _indexReducer = __webpack_require__(162);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _resizeReducer = __webpack_require__(163);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var INITIAL_STATE = {
	  ...
	  scalerX: _constants2.default.CURVE_SIZE,
	  absScalerX: 1
	};
	    ...
	    case 'EDITOR_RESIZE':
	      {
	        ...
	        newState['right'] = action.width - 178;
	        newState['scalerX'] = (_constants2.default.CURVE_SIZE + Math.max(action.width - 178, 0)) / 100;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _initPoints = __webpack_require__(176);

	var _initPoints2 = _interopRequireDefault(_initPoints);

	var _calculatePath = __webpack_require__(178);

	var _calculatePath2 = _interopRequireDefault(_calculatePath);

	var _deselectAll = __webpack_require__(181);

	var _deselectAll2 = _interopRequireDefault(_deselectAll);

	var _findSelectedIndecies = __webpack_require__(182);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _initPoint = __webpack_require__(177);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _calculateSegment = __webpack_require__(179);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _calculatePoint = __webpack_require__(180);
